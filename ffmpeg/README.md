...
A comprehensive collection of guides for processing, converting, and streaming audio and video with FFmpeg.

## 📚 Available Guides

| Guide | Description | Difficulty |
| ----- | ----------- | ---------- |
| [Complete FFmpeg Guide](./complete-guide.md) | Installation, concepts, encoding, filters, streaming, hardware acceleration, and troubleshooting | Beginner → Advanced |
...
- Command-line access (Terminal on macOS/Linux, PowerShell or WSL on Windows)
- Basic familiarity with file paths and shell commands
- Optional: sample media files for hands-on practice

## 🔧 What You'll Learn

- **Core tools**: `ffmpeg`, `ffprobe`, `ffplay`
...
- 📝 Real-world recipes (web, mobile, social, broadcast)
